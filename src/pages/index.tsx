  ...
  return (
    <Wrap>
      <div className="container-xxl mg-t-5 mg-b-5">
              ...
              <div className="card-content mg-l-6 mg-b-1 mg-r-6">
                <div style={{ width: '100%' }}>
                  ...
                  <div className="mg-b-5 between-display">
                    ...
                    <img
                      style={{ height: 100 }}
                      src="https://cdn.yellowimages.com/images/illustrations/tile_market-cs-1.png"
                    />
                  </div>
                </div>
              </div>
        ...
        <div className="content">
          <div className="header-section mg-t-6 mg-b-6">
            <div className="content-header-section" style={{ display: 'flex' }}>
              <div className="content-header mg-r-5">
                <img
                  style={{ width: 45, height: 45 }}
                  src="https://cdn.yellowimages.com/images/markets/om.svg"
                />
              </div>
                ...
                <div style={{ width: '100%' }} className="between-display">
                  ...
                  <div className="mg-b-5">
                    <img
                      ...
                      src="https://cdn.yellowimages.com/images/illustrations/tile_affiliate.png"
                    />
                  </div>
                </div>
              </div>
